...
import lib.core.api.event.RealDamageEvent;
...
public class ShowManager implements Listener, FunctionInterface {
    ...
    /**
     * @see #show(lib.core.api.inter.ShowInterface, Object, org.bukkit.entity.Player, String, String, lib.core.api.inter.ShowList, java.util.HashMap, int, int, java.util.List, java.util.List)
     */
    ...
    public static Page load(String plugin, String page, YamlConfiguration config) {
        ...
        //maps
        HashMap<String, lib.core.api.inter.Page.MapInfo> maps = null;
        List<String> mapsList = config.getStringList("maps");
        if (mapsList != null && !mapsList.isEmpty()) {
            maps = new HashMap<String, lib.core.api.inter.Page.MapInfo>();
            for (String s:mapsList) {
                ...
                maps.put(keyName, new lib.core.api.inter.Page.MapInfo(keyName, pluginName, pluginKey));
            }
        }
        //lines
        LinkedHashMap<Integer, lib.core.api.inter.Page.LineContext> lines = new LinkedHashMap<Integer, Page.LineContext>();
