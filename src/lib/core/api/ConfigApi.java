...
public class ConfigApi {
	...
	/**
	 * @see ConfigManager#register(java.io.File, String, java.util.List, String, lib.core.api.hashList.HashList)
	 */
    ...
    /**
     * @see ConfigManager#setDescription(String, lib.core.api.hashList.HashList)
     */
