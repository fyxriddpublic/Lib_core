...
public class ShowApi {
    ...
    /**
     * @see ShowManager#register(String, String)
     * @param plugin
     * @param name
     */
    ...
    /**
     * @see ShowManager#show(lib.core.api.inter.ShowInterface, Object, org.bukkit.entity.Player, String, String, lib.core.api.inter.ShowList, java.util.HashMap, java.util.List, java.util.List)
     */
    ...
    /**
     * @see ShowManager#reShow(PlayerContext)
     */
    ...
    /**
     * @see lib.core.show.ShowListImpl#ShowListImpl(int, Object)
     */
    ...
    /**
     * @see lib.core.show.ShowListImpl#ShowListImpl(int, Object, Class)
     */
    ...
    /**
     * @see lib.core.show.ShowManager#load(String, String)
     */
    ...
    /**
     * @see lib.core.show.ShowManager#load(String, String, org.bukkit.configuration.file.YamlConfiguration)
     */
    ...
    /**
     * @see lib.core.show.ShowManager#save(lib.core.api.inter.Page)
     */
